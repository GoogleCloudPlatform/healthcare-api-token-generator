...
//    private static final String OAUTH_TOKEN_URI = "https://www.googleapis.com/oauth2/v4/token";
    ...
    public static String getSignedJwt(ServiceAccountCredentials credentials, String iapClientId)
            throws Exception {
    ...
    public static String getGoogleIdToken(String jwt) throws Exception {
